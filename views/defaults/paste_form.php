		...
		<form action="<?php echo base_url(); ?>" method="post" class="form-vertical well">
			<div class="row">
				<div class="span3">
					...
					<?php $set = array('name' => 'name', 'id' => 'name', 'class' => 'span3', 'value' => "fullname", 'maxlength' => '32', 'tabindex' => '1', 'readonly' => 'true');
					echo form_input($set);?>
			...
			<div class="control-group">
				<div class="controls">
					<textarea id="code" class="col-xs-12" name="code" rows="20" tabindex="4"><?php if(isset($paste_set)){ echo $paste_set; }?></textarea>
				</div>
			</div>
			...
			<!--<div class="row">
				<div class="span8">
					...
					<div class="item">
						<label for="expire"><span class="instruction">When should we delete your paste?</span>
						</label>
						<?php
